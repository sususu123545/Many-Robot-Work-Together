...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.widget_12.setGeometry(QtCore.QRect(200, 380, 385, 161))
...
"border-color: rgb(200, 200, 200);}")
        ...
        self.widget_15.setGeometry(QtCore.QRect(630, 380, 85, 161))
...
"border-color: rgb(200, 200, 200);}")
        ...
        self.comboBox_color.setStyleSheet("background-color: rgb(240, 240, 240);\n"
"color: rgb(0, 0, 0);")
        self.comboBox_color.setInsertPolicy(QtWidgets.QComboBox.InsertAtTop)
        self.comboBox_color.setObjectName("comboBox_color")
        self.pushButton_labWrite = QtWidgets.QPushButton(self.widget_15)
        self.pushButton_labWrite.setGeometry(QtCore.QRect(5, 40, 75, 30))
        font = QtGui.QFont()
        font.setFamily("黑体")
        font.setPointSize(14)
...
"QPushButton{border-radius:5px;}")
        ...
        self.pushButton_AddColor.setGeometry(QtCore.QRect(5, 80, 75, 30))
        font = QtGui.QFont()
        font.setFamily("黑体")
        font.setPointSize(14)
...
"QPushButton{border-radius:5px;}")
        ...
        self.pushButton_exit.setGeometry(QtCore.QRect(5, 120, 75, 30))
        font = QtGui.QFont()
        font.setFamily("黑体")
        font.setPointSize(14)
        self.pushButton_exit.setFont(font)
        self.pushButton_exit.setStyleSheet("QPushButton{background-color: rgb(255, 165, 0);}\n"
"QPushButton:hover{background-color:  rgb(255, 210, 0);}\n"
"QPushButton{border-radius:5px;}")
        self.pushButton_exit.setObjectName("pushButton_exit")
        self.label_orign = QtWidgets.QLabel(self.tab)
        self.label_orign.setGeometry(QtCore.QRect(70, 50, 800, 300))
